  ...
  en: {
    translation: {
      ...
      account: {
        ...
        inviteToken: 'Invite token', acceptInvite: 'Accept invite', createInvite: 'Create invite', copyInvite: 'Copy token', revokeInvite: 'Revoke invite', members: 'Members', removeMember: 'Remove member', memberRemoved: 'Member removed.', inviteCreated: 'Invite created.', inviteCopied: 'Invite token copied.', inviteRevoked: 'Invite revoked.', inviteAccepted: 'Invite accepted.', signedOut: 'Signed out.',
