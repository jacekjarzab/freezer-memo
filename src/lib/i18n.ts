  ...
  en: {
    translation: {
      ...
      account: {
        ...
        signedInAs: 'Signed in as {{email}}', signOut: 'Sign out', householdName: 'Household name', createHousehold: 'Create household', householdCreated: 'Household created. Local data is still local until migration.', householdReady: 'Household connected. Sync migration is ready to be started.', migrationReady: 'Shared household is connected. Local inventory remains unchanged until you explicitly migrate it.', syncFailed: 'Shared sync needs attention. Local inventory is still available on this device.',
        inviteToken: 'Invite token', acceptInvite: 'Accept invite', createInvite: 'Create invite', copyInvite: 'Copy token', revokeInvite: 'Revoke invite', inviteCreated: 'Invite created.', inviteCopied: 'Invite token copied.', inviteRevoked: 'Invite revoked.', inviteAccepted: 'Invite accepted.', signedOut: 'Signed out.',
  ...
  pl: {
    translation: {
      ...
      account: {
        ...
        signedInAs: 'Zalogowano jako {{email}}', signOut: 'Wyloguj', householdName: 'Nazwa gospodarstwa', createHousehold: 'Utwórz gospodarstwo', householdCreated: 'Gospodarstwo utworzone. Lokalne dane nadal są lokalne do czasu migracji.', householdReady: 'Gospodarstwo połączone. Migracja synchronizacji jest gotowa do uruchomienia.', migrationReady: 'Wspólne gospodarstwo jest połączone. Lokalne dane pozostają bez zmian do czasu jawnej migracji.', syncFailed: 'Wspólna synchronizacja wymaga uwagi. Lokalne dane nadal są dostępne na tym urządzeniu.',
        inviteToken: 'Token zaproszenia', acceptInvite: 'Akceptuj zaproszenie', createInvite: 'Utwórz zaproszenie', copyInvite: 'Kopiuj token', revokeInvite: 'Unieważnij zaproszenie', inviteCreated: 'Zaproszenie utworzone.', inviteCopied: 'Token skopiowany.', inviteRevoked: 'Zaproszenie unieważnione.', inviteAccepted: 'Zaproszenie zaakceptowane.', signedOut: 'Wylogowano.',
