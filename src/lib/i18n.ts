  ...
  en: {
    translation: {
      ...
      account: {
        ...
        memberLabel: 'Member ···{{id}}', currentUser: '(me)',
        subtitle: 'Sign in only when you want to share inventory. Local-only mode stays unchanged until you migrate it.',
        email: 'Email', password: 'Password', newPassword: 'New password', confirmPassword: 'Confirm password', showPassword: 'Show password', hidePassword: 'Hide password', showConfirmPassword: 'Show confirmation password', hideConfirmPassword: 'Hide confirmation password', signIn: 'Sign in', createAccount: 'Create account', forgotPassword: 'Forgot password?', backToSignIn: 'Back to sign in', sendResetEmail: 'Send reset email', updatePassword: 'Update password', setPassword: 'Set password', signedIn: 'Signed in.', confirmationRequired: 'For a new account, check your email to confirm it. If you already used magic-link sign-in, use Forgot password instead.', existingAccountHint: 'Already used this email with magic-link sign-in? Return to sign in and choose Forgot password to set a password.', passwordResetSent: 'Check your email for a password reset link. It may open in your device browser.', passwordUpdated: 'Password updated.', resetPasswordDescription: 'Enter your email and we will send a password reset link.', emailLinkPlatformNote: 'Confirmation and recovery emails may open in your device browser instead of this installed app. Afterward, return here and sign in with your password.',
        signedInAs: 'Signed in as {{email}}', signOut: 'Sign out', householdName: 'Household name', createHousehold: 'Create household', householdCreated: 'Household created. Local data is still local until migration.', householdReady: 'Household connected. Start shared inventory to begin syncing.', migrationReady: 'Shared household is connected. Local inventory remains unchanged until you explicitly migrate it.', migrateInventory: 'Start shared inventory', migrationComplete: 'Inventory migrated and shared sync is active.', syncFailed: 'Shared sync needs attention. Local inventory is still available on this device.', syncStatus: { offline: 'Shared sync is offline.', syncing: 'Shared sync in progress.', up_to_date: 'Shared sync is up to date.', retrying: 'Shared sync will retry when the connection is available.', error: 'Shared sync needs attention; local data is preserved.' },
        inviteeEmail: 'Invitee email', sendEmailInvite: 'Send email invitation', emailInviteSent: 'Invitation email sent.', inviteToken: 'Invite token', acceptInvite: 'Accept invite', createInvite: 'Create invite token', copyInvite: 'Copy token', revokeInvite: 'Revoke invite', members: 'Members', removeMember: 'Remove member', memberRemoved: 'Member removed.', inviteCreated: 'Invite created.', inviteCopied: 'Invite token copied.', inviteRevoked: 'Invite revoked.', inviteAccepted: 'Invite accepted.', signedOut: 'Signed out.', working: 'Working…', migrationConfirm: 'Start sharing this device’s local inventory with the household? This cannot be undone offline.', signOutConfirm: 'Sign out of shared household?', revokeConfirm: 'Revoke this invitation?', removeMemberConfirm: 'Remove this member from the household?',
        errors: { missingConfiguration: 'Shared mode is not configured on this device.', forbidden: 'You no longer have access to this household. Sign in again or accept a new invite.', invite_invalid: 'That invite is invalid, expired, or revoked.', unavailable: 'The service is unavailable. Check your connection and retry.', invalid: 'That request was rejected. Check the details and retry.', auth_invalid: 'The email or password is incorrect.', auth_unconfirmed: 'Confirm your email before signing in.', accountExists: 'An account with this email already exists. Use sign in or reset your password.', rate_limited: 'Too many attempts. Wait a moment and try again.', passwordTooShort: 'Use at least 8 characters for your password.', passwordMismatch: 'The passwords do not match.', clipboard: 'Copy was blocked. Select and copy the invite token manually.', generic: 'The shared-household request failed. Retry.' },
      },
      pwa: {
        eyebrow: 'PWA status',
  ...
  pl: {
    translation: {
      ...
      account: {
        ...
        memberLabel: 'Członek ···{{id}}', currentUser: '(ja)',
        subtitle: 'Zaloguj się tylko wtedy, gdy chcesz współdzielić stan. Tryb lokalny pozostaje bez zmian do czasu migracji.',
        email: 'E-mail', password: 'Hasło', newPassword: 'Nowe hasło', confirmPassword: 'Potwierdź hasło', showPassword: 'Pokaż hasło', hidePassword: 'Ukryj hasło', showConfirmPassword: 'Pokaż potwierdzenie hasła', hideConfirmPassword: 'Ukryj potwierdzenie hasła', signIn: 'Zaloguj się', createAccount: 'Utwórz konto', forgotPassword: 'Nie pamiętasz hasła?', backToSignIn: 'Wróć do logowania', sendResetEmail: 'Wyślij wiadomość resetującą', updatePassword: 'Zmień hasło', setPassword: 'Ustaw hasło', signedIn: 'Zalogowano.', confirmationRequired: 'Dla nowego konta sprawdź skrzynkę i potwierdź adres. Jeśli logowałeś się już linkiem, użyj opcji „Nie pamiętasz hasła?”.', existingAccountHint: 'Jeśli ten e-mail był już używany do logowania linkiem, wróć do logowania i wybierz „Nie pamiętasz hasła?”, aby ustawić hasło.', passwordResetSent: 'Sprawdź skrzynkę, aby zresetować hasło. Link może otworzyć się w przeglądarce telefonu.', passwordUpdated: 'Hasło zostało zmienione.', resetPasswordDescription: 'Podaj e-mail, a wyślemy link do resetowania hasła.', emailLinkPlatformNote: 'Wiadomości potwierdzające i resetujące mogą otworzyć się w przeglądarce telefonu zamiast w zainstalowanej aplikacji. Potem wróć tutaj i zaloguj się hasłem.',
        signedInAs: 'Zalogowano jako {{email}}', signOut: 'Wyloguj', householdName: 'Nazwa gospodarstwa', createHousehold: 'Utwórz gospodarstwo', householdCreated: 'Gospodarstwo utworzone. Lokalne dane nadal są lokalne do czasu migracji.', householdReady: 'Gospodarstwo połączone. Uruchom wspólny inwentarz, aby rozpocząć synchronizację.', migrationReady: 'Wspólne gospodarstwo jest połączone. Lokalne dane pozostają bez zmian do czasu jawnej migracji.', migrateInventory: 'Uruchom wspólny inwentarz', migrationComplete: 'Zapasy zmigrowane, współdzielona synchronizacja jest aktywna.', syncFailed: 'Wspólna synchronizacja wymaga uwagi. Lokalne dane nadal są dostępne na tym urządzeniu.', syncStatus: { offline: 'Wspólna synchronizacja jest offline.', syncing: 'Wspólna synchronizacja trwa.', up_to_date: 'Wspólna synchronizacja jest aktualna.', retrying: 'Synchronizacja ponowi próbę po przywróceniu połączenia.', error: 'Synchronizacja wymaga uwagi; lokalne dane są zachowane.' },
        inviteeEmail: 'E-mail zapraszanej osoby', sendEmailInvite: 'Wyślij zaproszenie e-mailem', emailInviteSent: 'Zaproszenie e-mail zostało wysłane.', inviteToken: 'Token zaproszenia', acceptInvite: 'Akceptuj zaproszenie', createInvite: 'Utwórz token zaproszenia', copyInvite: 'Kopiuj token', revokeInvite: 'Unieważnij zaproszenie', members: 'Członkowie', removeMember: 'Usuń członka', memberRemoved: 'Członek został usunięty.', inviteCreated: 'Zaproszenie utworzone.', inviteCopied: 'Token skopiowany.', inviteRevoked: 'Zaproszenie unieważnione.', inviteAccepted: 'Zaproszenie zaakceptowane.', signedOut: 'Wylogowano.', working: 'Przetwarzanie…', migrationConfirm: 'Rozpocząć współdzielenie lokalnego inwentarza tego urządzenia? Tej operacji nie można cofnąć offline.', signOutConfirm: 'Wylogować ze wspólnego gospodarstwa?', revokeConfirm: 'Odwołać to zaproszenie?', removeMemberConfirm: 'Usunąć tego członka z gospodarstwa?',
        errors: { missingConfiguration: 'Tryb współdzielenia nie jest skonfigurowany na tym urządzeniu.', forbidden: 'Nie masz już dostępu do tego gospodarstwa. Zaloguj się ponownie lub przyjmij nowe zaproszenie.', invite_invalid: 'To zaproszenie jest nieprawidłowe, wygasło albo zostało unieważnione.', unavailable: 'Usługa jest niedostępna. Sprawdź połączenie i spróbuj ponownie.', invalid: 'Żądanie zostało odrzucone. Sprawdź dane i spróbuj ponownie.', auth_invalid: 'E-mail lub hasło są nieprawidłowe.', auth_unconfirmed: 'Potwierdź adres e-mail przed zalogowaniem.', accountExists: 'Konto z tym adresem e-mail już istnieje. Zaloguj się lub zresetuj hasło.', rate_limited: 'Zbyt wiele prób. Odczekaj chwilę i spróbuj ponownie.', passwordTooShort: 'Hasło musi mieć co najmniej 8 znaków.', passwordMismatch: 'Hasła nie są takie same.', clipboard: 'Kopiowanie zostało zablokowane. Zaznacz token i skopiuj go ręcznie.', generic: 'Żądanie współdzielenia nie powiodło się. Spróbuj ponownie.' },
      },
      pwa: {
        eyebrow: 'Status PWA',
